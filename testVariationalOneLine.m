...
params.pixelDim = .006;
params.b =  3*25.4*.0048/.006;         % stereo baseline
...
for i = 1:110
    ...
    [zEst_l(240,:), zEst1_1(240,:),rms(240)] = imrStereo_withGraphicsOneLine(-uv_ir{startSeq}(240,:,1), -uv_vl{startSeq}(240,:,1), zEst_l(240,:), params );
    waitbar(i/100)
end
close(h)